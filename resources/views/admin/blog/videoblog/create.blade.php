...
<div class="container">
    <center>  <h1> Create New Youtube Video Post</h1></center>
    <form class="form-group" method="post" action="store">
        {!! csrf_field() !!}
       Embaded Video Link: <input class="form-control" type="text" name="video_link" required> <br>
       Title: <input class="form-control" type="text" name="title" required> <br>
        ...
        Date of Post: <input class="form-control" type="text" name="date" required> <br>
